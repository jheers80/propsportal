...
INSERT INTO features (name, display_name, description, roles) VALUES
  ('dashboard', 'Dashboard', 'Main dashboard with overview', ARRAY['staff', 'manager', 'multiunit', 'superadmin']),
  ('profile', 'Profile Management', 'User profile management', ARRAY['staff', 'manager', 'multiunit', 'superadmin']),
  ('admin', 'Admin Panel', 'Administrative functions', ARRAY['superadmin']),
  ('audit', 'Audit Trails', 'System audit logs', ARRAY['superadmin'])
ON CONFLICT (name) DO NOTHING;
...
-- Set default role for profiles table
